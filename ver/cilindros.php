      ...
      <div class="row">
        ...
        <?php
            ...
            while ($reg = $rspta->fetch_object()) {
              ...
              echo '<center>';
              echo '<h4> <b> '.$reg->vc_descripcion.'</b> </h4> <br> <br>';
              echo '</center>';
              echo '<div id="example-25" class="ma5slider hover-navs hover-dots anim-horizontal outside-dots center-dots inside-navs loop-mode autoplay" data-tempo="3500">';
              echo '<div class="slides">';
              $rspta2 = $producto->listar_imagen_producto($reg->idcilindro);
              while ($reg2 = $rspta2->fetch_object()) {
                echo ' <img src="'.$reg2->url.'" alt="">';
              }
              echo '</div>';
              echo '</div>';
              echo '</div>';
              echo '<br>';
              echo '<center>';
              echo '<p> <b> CARACTERÍSTICAS </b> </p>';
              echo '</center>';
              echo '<div class="heightlight_details">';
              echo '<ul>';
              $rspta3 = $producto->listar_caracteristica_producto($reg->idcilindro);
              while ($reg3 = $rspta3->fetch_object()) {
                echo ' <li> <a><i class="icofont icofont-tick-mark"></i>'.$reg3->vc_descripcion.' </a> </li>';
              }
              echo '</ul>';
              echo '</div>';
              echo '</div>';
