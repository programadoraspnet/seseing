...
<head>
    ...
    <style>
        ...
        body {
            ...
            font-family: 'Arial', sans-serif; /* Tipo de letra base */
        }
        ...
        .aboutpg_text {
            ...
            font-family: 'Arial', sans-serif; /* Tipo de letra para el contenido */
            padding: 4px !important; /* Relleno para mayor legibilidad */
            box-sizing: border-box;
        }

        @media screen and (max-width: 600px) {
            /* Estilos específicos para pantallas con un ancho máximo de 600px (dispositivos móviles) */
            body {
                font-size: 14px; /* Reducción del tamaño de la fuente base para pantallas más pequeñas */
            }

            .aboutpg_text {
                font-size: 14px; /* Reducción del tamaño de la fuente para el contenido en pantallas más pequeñas */
            }
        }
    </style>
</head>
    ...
    <header>
        ...
        <div class="manu_area">
            <div class="container">
                <div class="row">
                    <div class="col-sm-4">
                        <div class="logo" style="margin-top: -17% !important;"> <a href="index.php"> <img src="../public/images/logo-empresa.png" style="margin-left: -25% !important;
    height: auto !important;
    display: block !important;
    /* margin: 0 auto !important; */
    max-width: 100% !important;
    width: 73% !important;" alt="RECOMSERMA" /> </a> </div>
                    </div>
                    <div class="col-sm-8">
                        <div class="mainnmenu">
                            <nav class="hidden-xs">
        ...
        <div class="container">
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <h1> <?php
                            $rspta = $inicio->obtener_inicio_servicio($_GET["id"]);
                            echo  $rspta["titulo"]
                            ?>
                    </h1>
                    <ul>
                ...
                <div class="row ">
                    <div class="col-sm-5">
                        <div class="aboutbox ">
                            <div class="aboutpg_text">
                                <p align="justify" style="font-size: 19px; margin: 0px !important;color:black !important;text-align: justify !important;">
                                    <?php
                                    $rspta = $inicio->obtener_inicio_servicio($_GET["id"]);
                                    print  $rspta["mensaje"]
                                    ?>
                    ...
                    <div class="col-sm-6">
                        <img src="<?php
                                    ...
                                    ?>" alt="" style="width: 100% !important;height: 100% !important;" /> <br><br>

                        <?php
                        $rspta1 = $inicio->obtener_inicio_servicio($_GET["id"]);
                        $rspta = $inicio->listar_sub_servicio($rspta1["idinicioservicio"]);
                        while ($reg = $rspta->fetch_object()) {
                            echo '<img src="' . $reg->url . '" alt="" /><br> <br>';
                        }
                        ?>
                    </div>
                </div>
